...
| **02 Cleaning & Preprocessing (4 Hours)** | Identifying missing values (MCAR/MAR/MNAR), listwise deletion, mean/median/mode/KNN imputation, Z-score outlier detection ($\vert Z \vert > 3$), Min-Max scaling, Standardization, deduplication, One-Hot encoding. | • [data-cleaning-imputation-scaling.md](02-data-cleaning-preprocessing/data-cleaning-imputation-scaling.md) |
